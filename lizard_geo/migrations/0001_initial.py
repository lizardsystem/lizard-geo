...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lizard_geo_geoobjectgroup', (
        ...
        db.send_create_signal('lizard_geo', ['GeoObjectGroup'])

        # Adding model 'GeoObject'
        db.create_table('lizard_geo_geoobject', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('geo_object_group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_geo.GeoObjectGroup'])),
        ))
        db.send_create_signal('lizard_geo', ['GeoObject'])


    def backwards(self, orm):
        
        # Deleting model 'GeoObjectGroup'
        db.delete_table('lizard_geo_geoobjectgroup')

        # Deleting model 'GeoObject'
        db.delete_table('lizard_geo_geoobject')
