...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'GeoObject', fields ['ident']
        db.delete_unique('lizard_geo_geoobject', ['ident'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'GeoObject', fields ['ident']
        db.create_unique('lizard_geo_geoobject', ['ident'])
