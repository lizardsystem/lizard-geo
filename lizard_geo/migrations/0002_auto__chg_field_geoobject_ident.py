...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GeoObject.ident'
        db.alter_column('lizard_geo_geoobject', 'ident', self.gf('django.db.models.fields.CharField')(unique=True, max_length=80))


    def backwards(self, orm):
        
        # Changing field 'GeoObject.ident'
        db.alter_column('lizard_geo_geoobject', 'ident', self.gf('django.db.models.fields.CharField')(max_length=16, unique=True))
